 ...
 * Generated at: 2023-05-23 23:27:33 UTC
...
public final class DataListClient_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    <div>\n");
      out.write("                        <h1>Listado de Clientes Registrados</h1>\n");
      out.write("                        <small> Este es un listado que muestra un resumen de los cliente registrados</small>\n");
      out.write("                    </div>\n");
 ...
 List<Cliente> listUsers = (List<Cliente>) request.getSession().getAttribute("listUsers");
      ...
      out.write("                                <form action=\"");
      out.print( request.getContextPath());
      out.write("/GetData?action=4&option=2\" method=\"post\">\n");
      out.write("                                    ");
 request.getSession().setAttribute("data" + user.getIdUser(), user);
      ...
      out.write("                                <form action=\"");
      out.print( request.getContextPath());
      out.write("/GetData?action=5&option=2\" method=\"post\">\n");
      out.write("                                    ");
 request.getSession().setAttribute("data" + user.getIdUser(), user);
      out.write("\n");
      out.write("                                    <input type=\"text\" value=\"");
      ...
      out.write("                                <form action=\"");
      out.print( request.getContextPath());
      out.write("/GetData?action=6&option=2\" method=\"post\">\n");
      out.write("                                    ");
 request.getSession().setAttribute("data" + user.getIdUser(), user);
      out.write("\n");
      out.write("                                    <input type=\"text\" value=\"");
      ...
      out.write("                                <form action=\"");
      out.print( request.getContextPath());
      out.write("/GetData?action=3&option=2\" method=\"post\">\n");
      out.write("                                    ");
 request.getSession().setAttribute("data" + user.getIdUser(), user);
      out.write("\n");
      out.write("                                    <input type=\"text\" value=\"");
